    ...
    public class VagaController : ControllerBase
    {
        ...
        public ViewModel.Vaga[] GetVagasGeraisPaginaInicial()
        {
            using (var service = new VagaService())
            {
                ...
                {
                    IdVaga = x.Id,
                    NomeCargo = x.ReferenceNumber != 0 ? x.ReferenceNumber + " - " + x.IdCargoNavigation.NomeCargo : x.IdCargoNavigation.NomeCargo,
        ...
        public ViewModel.Vaga GetVagaPorId(int idVaga, int idCandidato)
        {
            ...
            using (var service = new VagaService())
            {
                ...
                {
                    IdVaga = vaga.Id,
                    NomeCargo = vaga.ReferenceNumber != 0 ? vaga.ReferenceNumber + " - " + vaga.IdCargoNavigation.NomeCargo : vaga.IdCargoNavigation.NomeCargo,
